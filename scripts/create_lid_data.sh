...
function create_lid_data() {
    ...
    python -m agbaye.lid.train_fasttext_model \
        --data $data_dir/lid201-data-unsampled-african.tsv \
        --output $data_dir/lid201-model-african
}
